...
import static com.akai.fire.AkaiFireDrumSeqExtension.SE_CMD_RGB;
...
public class RgbButton {
	private final byte[] sysExCmd = new byte[] { SE_ST, MAN_ID_AKAI, DEVICE_ID, PRODUCT_ID, SE_CMD_RGB, 00, 04, 0, 0, 0,
			0, SE_EN };
