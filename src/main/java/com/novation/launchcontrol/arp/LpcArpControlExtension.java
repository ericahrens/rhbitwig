...
public class LpcArpControlExtension extends ControllerExtension implements ArpParameterContainer {
    ...
    private final byte[] buttonStateSysEx = {(byte) 0xF0, 0x00, 0x20, 0x29, 0x02, 0x11, 0x78, 0x00, 0x00, 0x00, (byte) 0xF7};
    ...
    public void init() {
        ...
        quantizeMode = documentState.getEnumSetting("Modes", //
                "Quantize", new String[]{QuantizeMode.MUTE.getDescriptor(), QuantizeMode.NEAREST_VALUE.getDescriptor()},
