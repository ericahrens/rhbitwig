...
public abstract class LpButton {
    ...
    public void bind(final Layer layer, final Runnable action, final BooleanSupplier state, final LpColor color) {
    ...
    public void bind(final Layer layer, final Runnable action, final LpColor onColor) {
    ...
    public void bindPressed(final Layer layer, final Consumer<Boolean> target, final LpColor onColor) {
        final RgbState onState = RgbState.of(onColor.getHiIndex());
        final RgbState offState = RgbState.of(onColor.getLowIndex());
        layer.bind(hwButton, hwButton.pressedAction(), () -> target.accept(true));
        layer.bind(hwButton, hwButton.releasedAction(), () -> target.accept(false));
    ...
    public void bindReleased(final Layer layer, Runnable action) {
    ...
    public void bindToggle(final Layer layer, final SettableBooleanValue boolValue, final LpColor onColor,
                           final LpColor offColor) {
        final RgbState onState = RgbState.of(onColor);
        final RgbState offState = RgbState.of(offColor);
