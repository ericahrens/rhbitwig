...
import com.yaeltex.seqarp168.device.ArpInstance;
import com.yaeltex.seqarp168.device.DeviceSlotState;
import com.yaeltex.seqarp168.device.DeviceSlotStateValueObject;
import com.yaeltex.seqarp168.device.FocusDevice;
import com.yaeltex.seqarp168.encoders.Encoder16StepLayout;
import com.yaeltex.seqarp168.encoders.Encoder2Device8StepLayout;
import com.yaeltex.seqarp168.encoders.Encoder8StepLayout;
import com.yaeltex.seqarp168.encoders.EncoderLayout;
import com.yaeltex.seqarp168.layer.OptionsButtonLayer;
import com.yaeltex.seqarp168.layer.StepGatePctButtonLayer;
import com.yaeltex.seqarp168.layer.StepMuteButtonLayer;
import com.yaeltex.seqarp168.layer.StepVelMuteButtonLayer;
import com.yaeltex.seqarp168.layer.StepVelocityPctButtonLayer;
import com.yaeltex.seqarp168.layer.YaeltexLayer;
import com.yaeltex.seqarp168.value.DeviceValueObject;
import com.yaeltex.seqarp168.value.SettableValueObject;
...
public class YaeltexArpControlExtension extends ControllerExtension {
    ...
    private void setUpHardware() {
        for (int i = 0; i < 32; i++) {
            ...
            encoder.setAdjustValueMatcher(midiIn.createRelativeSignedBit2CCValueMatcher(0, midiValue, 100));
