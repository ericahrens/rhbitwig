...
public class ColorButtonLedState extends InternalHardwareLightState {
	...
	public static final ColorButtonLedState RED_DIM = new ColorButtonLedState(YaelTexColors.RED, 2);
	...
	private static final ColorButtonLedState[] colorMap = new ColorButtonLedState[128];
