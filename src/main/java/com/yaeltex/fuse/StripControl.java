...
public record StripControl(int index, HardwareSlider mainFader, RgbButton abButton, RgbButton cueButton, RgbButton fxButton,
    ...
    public void applySurface() {
        ...
        double leftBound = index*width + 1.0;
