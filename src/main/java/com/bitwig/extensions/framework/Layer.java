...
public class Layer {
    ...
    private boolean shouldReplaceBindingsInLayersBelow = true;
    ...
    public final void setIsActive(final boolean isActive) {
        if (isActive != active) {
            if (isActive && layerGroup != null) {
                for (final Layer other : layerGroup.getLayers()) {
                    if (other != this) {
