...
public enum DawColor {
    ...
    LIGHT_BLUE("Light Blue", 0.2666666805744171, 0.7843137383460999, 1), //
    ...
    DawColor(final String name, final double red, final double green, final double blue) {
        this.name = name;
        lookupIndex = toLookupIndex(red, green, blue);
    }

    public static int toLookupIndex(final double red, final double green, final double blue) {
